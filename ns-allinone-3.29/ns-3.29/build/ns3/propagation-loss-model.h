...
class LogDistanceGaussianDistributionPropagationLossModel : public PropagationLossModel
{
public:
  /**
   * \brief Get the type ID.
   ...
   */
  static TypeId GetTypeId (void);
  LogDistanceGaussianDistributionPropagationLossModel ();
  ...
  void SetGaussianVariable (double gaussianValue);

  double GetGaussianVariable (void) const;
...
private:
   ...
   * Defined and unimplemented to avoid misuse
   */
  LogDistanceGaussianDistributionPropagationLossModel (const LogDistanceGaussianDistributionPropagationLossModel &);
  /**
   * \brief Copy constructor
   *
   * Defined and unimplemented to avoid misuse
   * \returns
   */
  LogDistanceGaussianDistributionPropagationLossModel & operator = (const LogDistanceGaussianDistributionPropagationLossModel &);
  ...
  double m_referenceDistance; //!< reference distance
  double m_referenceLoss; //!< reference loss
  double m_gaussian; // gaussian value from normal distribution
};
/* meu modelo */
